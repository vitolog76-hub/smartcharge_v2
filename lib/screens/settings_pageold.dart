...
class _SettingsPageState extends State<SettingsPage> with TickerProviderStateMixin {
  ...
  // Animation controllers per ogni sezione
  ...
  void initState() {
    ...
    // Inizializza animation controllers
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // SEZIONE VEICOLO (espandibile)
                    _buildExpandableSection(
                      key: 'vehicle',
                      title: l10n.userVehicleData,
                    ...
                    // SEZIONE BATTERIA (espandibile)
                    _buildExpandableSection(
                      key: 'battery',
                      title: l10n.batteryIntelligence,
                      icon: Icons.bolt,
                      child: _buildCard(
                        child: Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(l10n.contractDetails, 
                                          style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 12)
                                        ),
                                      ),
                                      const Icon(Icons.arrow_forward, color: Colors.cyanAccent, size: 16),
                                    ],
                                  ),
                                ),
                              ),
                                      ...
                                      ...homeProv.allContracts.map((contratto) {
                                        ...
                                        if (!isSelected && homeProv.chargeHistory.isNotEmpty) {
                                          ...
                                          if(homeProv.chargeHistory.length > 1) {
                                            mesi = ((homeProv.chargeHistory.last.date.year - homeProv.chargeHistory.first.date.year) * 12) + 
                                                   (homeProv.chargeHistory.last.date.month - homeProv.chargeHistory.first.date.month);
                                            if (mesi <= 0) mesi = 1;
                                          }
  ...
  // Widget per sezione espandibile
  Widget _buildExpandableSection({
    ...
    // Aggiorna animazione
    if (isExpanded && !_animationControllers[key]!.isAnimating && !_animationControllers[key]!.isCompleted) {
      _animationControllers[key]!.forward();
    } else if (!isExpanded && !_animationControllers[key]!.isAnimating && _animationControllers[key]!.isCompleted) {
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    // Icona animata
                    RotationTransition(
                      turns: Tween(begin: 0.0, end: 0.5).animate(_animations[key]!),
                      child: Icon(
                        Icons.chevron_right,
